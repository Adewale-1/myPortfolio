...
interface NL2SQLProjectDetailsProps {
  project: ProjectType;
  onClose: () => void;
}

const NL2SQLProjectDetails: React.FC<NL2SQLProjectDetailsProps> = ({ project, onClose }) => {
      ...
      <div className="project-details__body">
        <div className="project-details__main-image">
          <object 
            ...
            aria-label="Architecture diagram showing T5 and Gemma models"
          ...
          <div className="project-details__section">
            ...
            <div className="project-details__features">
              <li>
                ...
                <span><strong>T5 Fine-tuning:</strong> Trained on specific text-to-SQL dataset, achieving SQL exact match of 45-50% and record F1 score of 75-80%.</span>
              </li>
              <li>
                <i className="uil uil-brain"></i>
                <span><strong>In-context Learning:</strong> Zero-shot performance of 35-40% SQL match, rising to 40-45% with few-shot learning and prompt engineering.</span>
              </li>
            </div>
          </div>
...
export default NL2SQLProjectDetails; 